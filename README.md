...
The 82.4% is achieved by recovering a synthetic rule that was itself written in terms of
...
- **Spatial leakage in the train/test split.** `neighborhood_damage_rate` is assigned
  ...
  The held-out-city evaluation reveals total model collapse — 0.092 accuracy, well below
  the 4-class uniform baseline of 0.250; see
  [`docs/LIMITATIONS.md §L0`](docs/LIMITATIONS.md#l0--model-collapses-on-an-unseen-city-random-split-accuracy-is-not-evidence-of-generalisation).
