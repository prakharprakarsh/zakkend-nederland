...
3. **8 of 11 features are fully simulated** (`np.random.default_rng`), not measured. Only
   ...
   Bodemkaart GeoPackage spatial join (1,031 of 3,828 buildings = 26.9%, cached in
   `data/raw/bro_soil_cache.parquet`) + coordinate-based rule fallback (73.1%). Functions
